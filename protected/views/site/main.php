<!-- Main Slider -->
<section class="slider-container" style="background-image: url(<?php $this->baseUrl; ?>/static/frontend/images/slide-img-1-bg.png);">
        ...
        <div class="slides">
          ...
          <div class="slide">
            ...
            <div class="slide-image">
              ...
              <a href="#">
                <img src="<?php $this->baseUrl; ?>/static/frontend/images/slide-img-1.png" class="img-responsive" />
              </a>
            </div>
          ...
          <!-- Slide 2 -->
          <div class="slide" data-bg="<?php $this->baseUrl; ?>/static/frontend/images/slide-img-1-bg.png">

            <div class="slide-image">

              <a href="#">
                <img src="<?php $this->baseUrl; ?>/static/frontend/images/slide-img-2.png" class="img-responsive" />
              </a>
            </div>
          ...
          <div class="slide">
            ...
            <div class="slide-image">
              ...
              <a href="#">
                <img src="<?php $this->baseUrl; ?>/static/frontend/images/slide-img-3.png" class="img-responsive" />
              </a>
            </div>
      ...
      <div class="col-sm-3">
        ...
        <!-- Portfolio Item in Widget -->				<div class="portfolio-item">
          <a href="portfolio-single.html" class="image">
            <img src="<?php $this->baseUrl; ?>/static/frontend/images/portfolio-thumb.png" class="img-rounded" />
      ...
      <div class="client-logos carousel slide" data-ride="carousel" data-interval="5000">
        ...
        <div class="carousel-inner">
          ...
          <div class="item active">
            ...
            <a href="#">
              <img src="<?php $this->baseUrl; ?>/static/frontend/images/client-logo.png" />
            </a>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        ...
        <a href="#">
          <img src="<?php $this->baseUrl; ?>/static/frontend/images/logo@2x.png" width="100" />
        </a>
