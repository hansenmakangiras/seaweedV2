<?php
  ...
  class Seaweed extends CActiveRecord
  {
    ...
    public function rules()
    {
      ...
      return array(
        array('id_seaweed,nama_komoditi, jenis_komoditi, kadar_air, jumlah_bentangan, total_panen', 'required'),
        array('id_user, id_seaweed,jenis_komoditi, jumlah_bentangan, status', 'numerical', 'integerOnly' => true),
        //array('total_panen', 'numerical'),
        array('nama_komoditi', 'length', 'max' => 255),
        // The following rule is used by search().
        // @todo Please remove those attributes that should not be searched.
        array(
          'id, id_user, id_seaweed,nama_komoditi, jenis_komoditi, kadar_air, jumlah_bentangan, total_panen, status, created_date, created_by',
          'safe',
          'on' => 'search',
        ),
      );
