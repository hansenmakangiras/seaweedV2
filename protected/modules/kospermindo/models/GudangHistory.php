...
class GudangHistory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('kabupaten, kode_jenis_gudang,provinsi, luas, status, id_gudang', 'numerical', 'integerOnly'=>true),
			...
			array('id,kode_gudang,kode_jenis_gudang, nama, alamat, kabupaten, provinsi, latitude, longitude, luas, telp, koordinator, status, id_gudang, created_date, created_by', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return $className GudangHistory the static model class
	 */
