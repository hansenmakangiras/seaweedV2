...
<!-- <div class="col-sm-3">
    ...
    <div class="tile-stats tile-red">
      ...
      xmlns:xlink="http://www.w3.org/1999/xlink" class="icon-seaweed">
          <g id="Layer_x0020_1">
      ...
      <div class="num" data-start="0" data-end="<?= !empty($allFarmers) ? $allFarmers : "0";?>" data-postfix="" data-duration="1500" data-delay="0">0
      </div>
...
<br/>
  ...
  <!-- <div class="col-sm-3">
   ...
   <div class="tile-title tile-cyan">
      ...
      <div class="title">
        <a href="<?= $this->baseUrl; ?>/kospermindo/report/warehouse"><h3>Warehouse Report</h3>
        <p>Details for warehouse</p></a>
      </div>
    </div>
  </div>
  <div class="col-sm-3">
   ...
   <div class="tile-title tile-cyan">
      ...
      <div class="title">
        <a href="<?= $this->baseUrl; ?>/kospermindo/report/farmers"><h3>Group Report</h3>
        <p>Details for Farmers</p></a>
      </div>
    </div>
  ...
  <div class="col-sm-3">
   ...
   <div class="tile-title tile-cyan">
      ...
      <div class="title">
        <a href="<?= $this->baseUrl; ?>/kospermindo/report/warehouse"><h3>Farmers Report</h3>
        <p>Details for Farmers</p></a>
      </div>
    </div>
...
<hr/>
    <div class="tabs-vertical-env">
      <ul class="nav tabs-vertical"><!-- available classes "right-aligned" -->
        <li class="active"><a href="#profile-1" data-toggle="tab">Laporan Komoditi</a></li>
        <li class=""><a href="#profile-2" data-toggle="tab">Laporan Petani</a></li>
        <li class=""><a href="#profile-3" data-toggle="tab">Laporan Kelompok</a></li>
        <li class=""><a href="#profile-4" data-toggle="tab">Laporan Gudang</a></li>
      </ul>
    ...
    vertical-align: middle"><center>Euchema Cotoni</center></th>
        ...
        <button type="button" class="btn btn-primary btn-icon" >
          ...
          <?php foreach ($allfarmerMenu as $key=> $value) { ?>
            <tr>
              <td class="text-center"><a href="<?= $this->baseUrl; ?>/kospermindo/report/detil?id=<?= strtolower($value->id); ?>"><?= $value->nama_petani?></a></td>
              <td class="text-center"><?= $farmergroup[$key][0]['nama_kelompok'];?></td>
              <td class="text-center"><?= $farmergroup[$key][0]['idgudang'];?></td>
        ...
        <button type="button" class="btn btn-primary btn-icon" id="cetak" >
            Cetak
            <i class="entypo-mail"></i>
          </button>
          <table class="table table-hover table-responsive " id="printTable">
          <thead>
          <tr>
            <th class="text-center">Lokasi</th>
          ...
          <tr>
            ...
            <td class="text-center"><?= !empty($total_panen[$key]) ? $total_panen[$key] : "0";?></td>
          </tr>
          <?php } ?>
          </tbody>
        </table>
