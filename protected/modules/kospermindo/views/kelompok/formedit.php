                            ...
                            <div class="panel-body">
                                <?php $form=$this->beginWidget('CActiveForm', array(
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                        <input  class="form-control" type="hidden" name="kelompok[id_kelompok]" value="<?php echo $kelompok['id_kelompok']; ?>">
                                        <input  class="form-control" type="text" name="kelompok[nama_kelompok]" value="<?php echo $kelompok['nama_kelompok']; ?>">
                                        </div>
                                    </div>
                                    <div class="hr-dashed"></div>
                                    <div class="form-group">
