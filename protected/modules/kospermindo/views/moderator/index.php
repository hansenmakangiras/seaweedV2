<?php
	Yii::app()->clientScript->registerScript('search', "
		var element = $('#main-menu li[data-nav=\"moderator\"]');
							...
							<tr>
								...
								<td>
									...
									<a href="#" data-record-id="<?= $vuser->id ?>" data-record-title="Konfirmasi"
										 data-href="<?php echo $this->baseUrl; ?>/kospermindo/moderator/delete"
	...
	Yii::app()->clientScript->registerScript('close-alert', '
		...
		$(document).ready(function(){
			...
			$("#form-moderator").submit(function(e){
				...
				$.ajax({
					type: "POST",
					url: "/kospermindo/moderator/createusers",
					data:{
			...
			$(document).on("click","#sunting", function(){
				...
				$.ajax({
					type: "POST",
					url: "/kospermindo/moderator/getusers",
					data:{
			...
			$("#edit").on("click", function(){
				...
				$.ajax({
					type: "POST",
					url: "/kospermindo/moderator/updateusers",
					data:{
