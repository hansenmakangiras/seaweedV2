...
<![endif]-->
<script src="<?php echo $this->baseUrl ?>/static/admin/js/gsap/main-gsap.js"></script>
<script src="<?php echo $this->baseUrl ?>/static/admin/js/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js"></script>
<script src="<?php echo $this->baseUrl ?>/static/admin/js/bootstrap.js"></script>
<script src="<?php echo $this->baseUrl ?>/static/admin/js/joinable.js"></script>
<script src="<?php echo $this->baseUrl ?>/static/admin/js/resizeable.js"></script>
<script src="<?php echo $this->baseUrl ?>/static/admin/js/jquery.nestable.js"></script>
...
<script src="/static/admin/js/bootstrap-switch.min.js"></script>
<script src="/static/admin/js/jquery.multi-select.js"></script>
...
<!--<script src="--><?php //echo $this->baseUrl ?><!--/static/admin/js/neon-charts.js"></script>-->
...
<script src="<?php echo $this->baseUrl ?>/static/admin/js/bootstrap-timepicker.min.js"></script>
