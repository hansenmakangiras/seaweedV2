...
<div class="row">
  <div class="col-md-9 col-sm-7">
    <h2>Farmers Details : <strong><?php echo ucfirst($_GET['gid']); ?></strong></h2>
  </div>
    ...
    <div class="member-details">
      ...
      <div class="row info-list">
        ...
        <div class="col-sm-4">
          ...
          <a href="#">Identity Number : <?= !empty($value->nmr_identitas) ? $value->nmr_identitas : "No Results"; ?></a>
        </div>
        ...
        <div class="col-sm-4">
          ...
          <a href="#">Group Name : <strong><?php echo $_GET['gid']; ?></strong></a>
        </div>

        <div class="col-sm-4">
      <i class="entypo-phone"></i>
          <a href="#">Phone : <strong><?= $value->no_telp; ?></strong> </a>
        </div>
