<ol class="breadcrumb bc-3">
  ...
  <li class="active">
    <strong><?php echo 'Gudang'; ?></strong>
  </li>
</ol>
<div class="row">
  <div class="col-md-12">
    <h2 class="page-title">Manajemen Petani</h2>
    ...
    <div class="panel panel-primary" data-collapsed="0">
      ...
      <div class="panel-heading">
        <div class="panel-title">
          ...
          <a href="<?php echo $this->baseUrl; ?>/kospermindo/petani/create" class="btn btn-default" id="<?php //if($pesan=='gagal') { echo "add"; } ?>"><i class="entypo-plus"></i> Tambah Petani</a>
        </div>
