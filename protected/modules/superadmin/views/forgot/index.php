<div class="login-header login-caret">
  ...
  <div class="login-content">
    ...
    <p class="description">Lupa Sandi? Silahkan isi alamat surel anda untuk kemudian dikirimkan kembali.</p>
...
<?php
  Yii::app()->clientScript->registerScriptFile(SAdmin::module()->getAssetsUrl().'/superadmin-forgotpassword.js',CClientScript::POS_END);
?>
