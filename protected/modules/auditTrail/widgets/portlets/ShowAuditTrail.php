<?php
  ...
  class ShowAuditTrail extends CPortlet
  {
     ...
     * @return string $userEvalLabel code to be evaled to display the user info correctly
     */
     ...
     * @var string $value The name of the value you would like to look up
     * @return string $at config value you need
     */
